...
import { Loader2, Phone, User, BookOpen, RotateCcw, CheckCircle } from "lucide-react"
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      {showSuccess && (
        <Alert className="bg-green-50 border-green-200 text-green-800">
          ...
          <AlertDescription>Registrasi mahasiswa berhasil! Data telah tersimpan dalam sistem.</AlertDescription>
        </Alert>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="number" className="text-sm font-medium text-gray-700 flex items-center space-x-2">
